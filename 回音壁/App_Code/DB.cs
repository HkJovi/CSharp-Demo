...
{
    public static SqlConnection GetNewConn()
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["zrxxConnectionString"].ConnectionString);
        conn.Open();
        return conn;
    }
...
public class DBCls
{
    ...
    public DBCls()
    {
        Init(ConfigurationManager.ConnectionStrings["zrxxConnectionString"].ConnectionString);
    }
