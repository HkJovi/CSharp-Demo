...
(function ($) {
	...
	function Wysiwyg() {
		...
		this.defaults = {
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "/www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="/www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
			debug: false,
			controls: {},
			css: {},
			events: {},
			autoGrow: false,
			autoSave: true,
			brIE: true,					// /code.google.com/p/jwysiwyg/issues/detail?id=15
			formHeight: 270,
			formWidth: 440,
			iFrameClass: null,
			initialContent: "",
			...
			resizeOptions: false,
			rmUnusedControls: false,	// /github.com/akzhan/jwysiwyg/issues/52
			rmUnwantedBr: true,			// /code.google.com/p/jwysiwyg/issues/detail?id=11
		...
		this.ui.appendItem = function (name, control) {
			...
			return $('<li role="menuitem" unselectable="on">' + (className) + "</li>")
				...
				.click(function (event) {
					...
					/**
					* @link /github.com/akzhan/jwysiwyg/issues/219
					*/
		...
		this.init = function (element, options) {
			...
			if (this.options.iFrameClass) {
				...
				this.editor.css({
					...
					// fix for issue 12 ( /github.com/akzhan/jwysiwyg/issues/issue/12 )
					width: "100%"
				});
			 ...
			 * ( /github.com/akzhan/jwysiwyg/issues/245 )
			 */
			if (element.id) {
			...
			/**
			 * /code.google.com/p/jwysiwyg/issues/detail?id=96
			 */
			...
			/**
			 * @link /code.google.com/p/jwysiwyg/issues/detail?id=52
			 */
		...
		this.ui.initFrame = function () {
			...
			self.editorDoc.write(
				self.options.html
					/**
					 * @link /code.google.com/p/jwysiwyg/issues/detail?id=144
					 */
            ...
            /**
             * @link /github.com/akzhan/jwysiwyg/issues/251
             */
			...
			/**
			 * @link /code.google.com/p/jwysiwyg/issues/detail?id=20
			 */
			...
			/**
			 * XHTML5 {@link /github.com/akzhan/jwysiwyg/issues/152}
			 */
		...
		this.insertHtml = function (szHTML) {
			...
			if ($.browser.msie) {
				...
				if ($.browser.mozilla) { // @link /github.com/akzhan/jwysiwyg/issues/50
					if (1 === $(szHTML).length) {
	...
	$.wysiwyg = {
		...
		/**
		 * Custom control support by Alec Gorge ( /github.com/alecgorge )
		 */
