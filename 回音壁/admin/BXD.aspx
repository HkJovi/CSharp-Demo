<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="BXD.aspx.cs" Inherits="admin_BXD" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>投诉建议分级处理系统后台管理 - 不选登的信件</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <!-- Begin one column window -->
      <div class="onecolumn">
        <div class="header"> <span>未选登的信件</span> </div>
        <br class="clear"/>
        <div class="content">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="umc" HeaderText="最终回复" SortExpression="umc" />
                    <asp:BoundField DataField="hits" HeaderText="点击数" SortExpression="hits" />
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                                <asp:LinkButton ID="btXD" runat="server" 
                                CommandArgument='<%# Eval("xjid") %>' onclick="btXD_Click">选登</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
